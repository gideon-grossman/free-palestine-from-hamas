...
const EXAMPLE_IMG_URL = "https://www.livemint.com/lm-img/img/2023/10/10/600x338/California-Israel-Palestinians-2_1696901506265_1696901545401.jpg";
const Post = () => {
...
onClick={() => setShareModalOpen(false)}><SocialIcon url="https://instagram.com" href="https://instagram.com" style={{width:'32px', height: '32px', }}/></IconButton>
      <FacebookShareButton
        url={currPostURL}
      >
...
<Box sx={{display: 'flex', flexDirection: 'column'}}>
    <Box sx={{width: '300px', height: '300px', backgroundColor: 'black', borderRadius: '8px', color: 'white', textAlign: 'center', padding: '16px'}}><img src={currPostURL} width="300px" /></Box>
